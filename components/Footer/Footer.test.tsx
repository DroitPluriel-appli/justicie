...
describe('pied de page', () => {
  ...
  it('affiche les liens', () => {
    ...
    const rechercheLieuDeDroit = within(liensJusticePlurielle[0]).getByRole('link', { name: wording.RECHERCHER_UN_LIEU_DE_DROIT })
    ...
    expect(liensQualiteDeService[1].textContent).toBe(wording.SOURDS_ET_MALENTENDANTS)
