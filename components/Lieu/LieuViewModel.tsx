...
export class LieuViewModel {
  constructor(private readonly criteres: Critere[], private readonly lieu: Lieu, private readonly wording: Wording) {}
  ...
  itineraire(latitude: number, longitude: number): ReactElement {
    return (
      <ExternalLink
