...
export class WordingFr implements Wording {
  ...
  readonly TITLE_ACCESSIBILITE_HANDICAP_MOTEUR_TOTAL: string = 'Accessibilité handicap moteur totale'
  readonly DESCRIPTION_ACCESSIBILITE_HANDICAP_MOTEUR_TOTAL: string = 'Le lieu permet un accès total à toute situation de handicap moteur'

  readonly TITLE_ACCESSIBILITE_HANDICAP_MOTEUR_AVEC_ASSISTANCE: string = 'Accessibilité handicap moteur'
  ...
  readonly TITLE_ACCESSIBILITE_HANDICAP_VISUEL: string = 'Accessibilité handicap Visuel'
  readonly DESCRIPTION_ACCESSIBILITE_HANDICAP_VISUEL: string = "Le guidage au sein du lieu est simple : bande de guidage, accueil dès l'entrée..."
