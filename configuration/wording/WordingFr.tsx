...
export class WordingFr implements Wording {
  ...
  readonly TITLE_PAGE_RECHERCHER_LIEU: string = 'Recherche un lieu de droit'
  ...
  // Footer
  readonly RECHERCHER_UN_LIEU_DE_DROIT: string = this.TITLE_PAGE_RECHERCHER_LIEU
  ...
  readonly SOURDS_ET_MALENTENDANTS: string = 'Sourds et malentendants - Accéo'
