export interface Wording {
  ...
  readonly TITLE_ACCESSIBILITE_HANDICAP_MOTEUR_TOTAL: string
  readonly DESCRIPTION_ACCESSIBILITE_HANDICAP_MOTEUR_TOTAL: string

  readonly TITLE_ACCESSIBILITE_HANDICAP_MOTEUR_AVEC_ASSISTANCE: string
  readonly DESCRIPTION_HANDICAP_MOTEUR_AVEC_ASSISTANCE: string

  readonly TITLE_ACCESSIBILITE_HANDICAP_VISUEL: string
  readonly DESCRIPTION_ACCESSIBILITE_HANDICAP_VISUEL: string
